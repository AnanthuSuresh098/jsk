      ...
      <div id="footer-main-wrapper">
        ...
        <div id="footer-quick-link-copyright-section-wrap">
          <div id="footer-quick-link-section-wrap">
            ...
            <a href="">
              <div classNames="footer-quick-link-section-links">
                About Company
              </div>
            </a>

            <a href="">
              <div classNames="footer-quick-link-section-links">Products</div>
            </a>

            <a href="">
              <div classNames="footer-quick-link-section-links">Markets</div>
            </a>

            <a href="">
              <div classNames="footer-quick-link-section-links">FAQ’ s</div>
            </a>
          </div>
